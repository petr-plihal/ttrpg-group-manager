...
class Application(models.Model):
    applicantid = models.ForeignKey('User', models.DO_NOTHING, db_column='applicantid')
...
class User(models.Model):
    ...
    description = models.CharField(max_length=600, blank=True, null=True)
    candm = models.IntegerField(blank=True, null=True)
