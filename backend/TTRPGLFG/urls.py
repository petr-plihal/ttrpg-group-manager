...
urlpatterns = [
    ...
    re_path("^getUserGroups/(?P<user_id>\\d+)/?$", views.getUserGroups, name="getUserGroups"),
    re_path("^getGroupOwner/(?P<group_id>\\d+)/?$", views.getGroupOwner, name="getGroupOwner"),
    re_path("^getPlayerPreferences/(?P<user_id>\\d+)/?$", views.getPlayerPreferences, name="getPlayerPreferences"),
    re_path("^getGroupTags/(?P<group_id>\\d+)/?$", views.getGroupTags, name="getGroupTags"),
    re_path("^getUserSessions/(?P<user_id>\\d+)/?$", views.getUserSessions, name="getUserSessions"),
