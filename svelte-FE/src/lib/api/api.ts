...
export const api = {
	...
	denyApplication: (applicationID: number) => request(`/denyApplication/${applicationID}`),
	acceptApplication: (applicationID: number) => request(`/acceptApplication/${applicationID}`),
	...
	updateUser: (userID: number) => request(`/user/${userID}/update`),
	updateGroup: (groupID: number) => request(`/group/${groupID}/update`),
	...
	setGroupOwner: (groupID: number) => request(`/group/${groupID}/setOwner`),
